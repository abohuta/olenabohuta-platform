  ...
  return (
    <main className="w-full overflow-x-hidden">
      ...
      <section className="px-6 md:px-20 py-32 min-h-screen max-w-3xl">
        ...
        <h1 className="text-5xl font-light text-[var(--dark)] mb-8">Політика конфіденційності</h1>
        <p className="text-lg text-[var(--light-text)]">Текст політики конфіденційності буде додано.</p>
      </section>
    </main>
  );
}