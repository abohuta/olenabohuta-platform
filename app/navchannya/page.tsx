  ...
  return (
    <main className="w-full overflow-x-hidden">
      ...
      <section className="px-6 md:px-20 py-32 min-h-screen">
        <p className="text-xs tracking-[0.35em] uppercase text-[var(--accent)] mb-4">Навчання</p>
        <h1 className="text-5xl md:text-7xl font-light text-[var(--dark)] mb-8">Всі продукти</h1>
        <p className="text-lg text-[var(--light-text)]">Скоро тут з'явиться каталог навчань.</p>
      </section>
    </main>
  );
}